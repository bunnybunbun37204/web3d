      ...
      <center>
        ...
        <table>
          <tr>
            ...
            <td style="text-align: center;" class="table-secondary"> <?php echo round($w, 2);
                                                                      $w; ?> ลูกบาศก์หน่วย</td>
          </tr>
          <tr>
            <td style="text-align: center;" class="table-danger"> ยาว : </td>
            <td style="text-align: center;" class="table-danger"><?php echo round($l, 2);
                                                                  $l; ?> ลูกบาศก์หน่วย</td>
          </tr>
          <tr>
            <td style="text-align: center;" class="table-success" > สูง : </td>
            <td style="text-align: center;" class="table-success"> <?php echo round($h, 2);
                                                                    $h; ?> ลูกบาศก์หน่วย</td>
          </tr>
          <tr>
            <td style="text-align: center;" class="table-warning"> พื้นที่ผิวที่น้อยที่สุด : </td>
            <td style="text-align: center;" class="table-warning"> <?php echo round($m, 2);
                                                                    $m; ?> ลูกบาศก์หน่วย</td>
          </tr>
        </table>
